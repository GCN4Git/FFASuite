...
Partial Public Class SMSCLIENTS
	...
	Private _SENTSIPMPLESMS As Boolean
    ...
    End Sub
    Partial Private Sub OnSENTSIPMPLESMSChanging(value As Boolean)
    End Sub
    Partial Private Sub OnSENTSIPMPLESMSChanged()
    End Sub
    #End Region
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_SENTSIPMPLESMS", DbType:="Bit NOT NULL"),  _
	 Global.System.Runtime.Serialization.DataMemberAttribute(Order:=10)>  _
	Public Property SENTSIPMPLESMS() As Boolean
		Get
			Return Me._SENTSIPMPLESMS
		End Get
		Set
			If ((Me._SENTSIPMPLESMS = value)  _
						= false) Then
				Me.OnSENTSIPMPLESMSChanging(value)
				Me.SendPropertyChanging
				Me._SENTSIPMPLESMS = value
				Me.SendPropertyChanged("SENTSIPMPLESMS")
				Me.OnSENTSIPMPLESMSChanged
			End If
		End Set
	End Property
